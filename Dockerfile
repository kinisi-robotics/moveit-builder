...
# Make sure the snapshot is supported in https://github.com/JafarAbdi/moveit-builder
...
RUN echo "deb [trusted=yes] https://raw.githubusercontent.com/JafarAbdi/moveit-builder/stable-${SYNC_DATESTAMP}/ ./" | \
    ...
    echo "yaml https://raw.githubusercontent.com/JafarAbdi/moveit-builder/stable-${SYNC_DATESTAMP}/local.yaml humble" | \
